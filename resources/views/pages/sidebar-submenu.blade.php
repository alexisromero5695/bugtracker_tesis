    ...
    @if(isset($menu))
        @foreach ($menu as $submenu)
            ...
            <li class="nk-menu-item">                           
                <a href="<?php echo ( $submenu->url != "" && $submenu->url != null) ? $submenu->url : "javascript:void(0)"?>" class="nk-menu-link">
            ...
            <li class="nk-menu-item has-sub {{ request()->is('sites/*/edit') ? 'active' : '' }}">
                <a href="<?php echo ( $submenu->url != "" && $submenu->url != null) ? $submenu->url : "javascript:void(0)"?>" class="nk-menu-link nk-menu-toggle">
